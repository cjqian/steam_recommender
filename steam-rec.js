...
/* .......................................................................... */
  ...
  */
  function getGameInfo( n, nodeArray ) {
    ...
    //rating
    if( n.rating )
      info += '<div class=f><a href= ' + n.rating.url + '/><span class=l>Rating</span>: <span class=c>' 
           + n.rating.score + '</span></div>';

    //recommendations
    if( n.recommendations )
      info += '<div class=f><a href= ' + n.recommendations + '/><span class=l>Number of recommendations</span>: <span class=c>' 
    ...
    info += '[<a href="javascript:void(0);" onclick="selectMovie('  
         + idx + ',true);">' + nodeArray[idx].title + '</a>]'
      });
      info += '</div>';
    return info;
  }
